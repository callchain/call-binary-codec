...
const DROPS_PER_CALL = new Decimal('1e6');
const MAX_NETWORK_DROPS = new Decimal('1e17');
const MIN_CALL = new Decimal('1e-6')
const MAX_CALL = MAX_NETWORK_DROPS.dividedBy(DROPS_PER_CALL);
...
const Amount = makeClass({
  ...
  statics: {
    ...
    fromParser(parser) {
      ...
      const callValue = drops.dividedBy(DROPS_PER_CALL);
